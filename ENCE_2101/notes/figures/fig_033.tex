...
\begin{tikzpicture}
  ...
  \draw[] ($(a)+(1.5,1.5)$) node[anchor = south east, xshift = -1] {{\footnotesize 2}} node[rotate = 0, anchor = center] {1};
  ...
  \filldraw[fill=re!50!bg, draw=re, ultra thick, rounded corners, fill opacity = 0.5, draw opacity = 0.8] ($(b)+(1.1,0.1)$) rectangle ++(0.8,1.8);

  \draw[] ($(b)+(0.5,1.5)$) node[rotate = 0, anchor = center] {0};
  \draw[] ($(b)+(0.5,0.5)$) node[rotate = 0, anchor = center] {0};
  \draw[] ($(b)+(1.5,1.5)$) node[rotate = 0, anchor = center] {1};
